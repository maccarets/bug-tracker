...
urlpatterns = [
    ...
    path(
        "shared_project/",
        SharedProjectListView.as_view(),
        name="shared_project_list"
    ),
    path(
        "project/create/",
    ...
    path(
        "testrun/<int:pk>/update/",
        TestRunUpdateView.as_view(),
        name="testrun_update"
    ),
    path(
        "testrun/<int:pk>/delete/",
        TestRunDeleteView.as_view(),
        name="testrun_delete"
    ),
    path(
        "testrun/<int:pk>/add_test_case/",
        AddTestCaseView.as_view(),
        name="add_test_case",
    ),
    # Test Case URLs
    path(
    ...
    path(
        "testresult/<int:pk>/update/",
        TestResultUpdateView.as_view(),
        name="testresult_update",
    ),
    path(
        "testresult/<int:result_id>/",
